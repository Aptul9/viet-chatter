...
| 7   | ~~**Dashboard locale con Next.js**~~ — **PROMOSSO IN SCOPE 2026-05-16 come Spec C**. Vedi [`specs/2026-05-16-spec-c-dashboard.md`](specs/2026-05-16-spec-c-dashboard.md). Include anche D1 (AI summary) e D2 (AI command channel write-capable) come spec collegati.                                                                                                | (Non piu' speculative.)                                                                                                                                                                                                                                                          |
